    ...
    return (
        <section ref={refAbout} className={`flex flex-col w-1/2 h-screen text-white justify-center items-start opacity-0 ${isVisibleAbout ? 'animate-fade-bottom-y-4' : ''}`} id='hero'>
            ...
            <div className="w-full h-auto flex flex-row justify-start items-center animate-fade-bottom-y-5 opacity-0 mt-6" style={{ animationDelay: ".8s" }}>
                <a href="https://alidev-portfolio.vercel.app/" target="_blank" className="bg-[#161616] relative z-30 cursor-pointer flex justify-center items-center w-40 h-12 rounded-lg border-2 border-[#2E28A0] font-bold text-xl text-white transform transition duration-300 hover:-translate-x-1 hover:-translate-y-1">
                    Portfolio
                </a>
