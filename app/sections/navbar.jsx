...
export const NavBar = () => {
    ...
    return (
        <nav className={`flex flex-row w-full h-24 justify-start items-center transition-transform duration-300 fixed bg-[#161616] z-50 shadow-[0_10px_20px_-2px_#101010] ${showNav ? 'transform translate-y-0' : 'transform -translate-y-24'}`}>
            <div className="flex flex-row w-1/3 h-full justify-start items-center pl-5 animate-fade-1 opacity-0" style={{animationDelay: ".5s"}}>
            ...
            <ul className="flex flex-row text-white w-1/2 h-full justify-between items-center font-semibold text-xl ml-10">
                <a href="#dev" className="transform transition duration-200 hover:text-[#2E28A0] cursor-pointer animate-fade-up-1">
                    <span className="text-[#2E28A0] font-semibold">01.</span> Web development
                </a>
                <a href="#cloud" className="transform transition duration-200 hover:text-[#2E28A0] cursor-pointer animate-fade-up-1">
                    <span className="text-[#2E28A0] font-semibold">02.</span> Cloud
                </a>
                <a href="#db" className="transform transition duration-200 hover:text-[#2E28A0] cursor-pointer animate-fade-up-2">
                    <span className="text-[#2E28A0] font-semibold">03.</span> Databases
                </a>
                <a href="#network" className="transform transition duration-200 hover:text-[#2E28A0] cursor-pointer animate-fade-up-3">
                    <span className="text-[#2E28A0] font-semibold">04.</span> Networks
                </a>
                <a href="#lang" className="transform transition duration-200 hover:text-[#2E28A0] cursor-pointer animate-fade-up-4">
