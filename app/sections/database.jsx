...
import Index from "../components/database";
...
export default function Databases() {
    ...
    return (
        <section ref={refAbout} className={`pt-28 mb-20 md:mb-40 2xl:mb-40 flex flex-col w-full px-10 lg:px-0 lg:pr-48 lg:w-5/6 h-auto text-white justify-center items-start opacity-0 ${isVisibleAbout ? 'animate-fade-bottom-y-4' : ''}`} style={{ animationDelay: ".2" }} id='db'>
            <Index />
