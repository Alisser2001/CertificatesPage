    ...
    return (
        <a key={idx + Math.random()*(1000000-1)+1} href={`viewpdf/${info.platform} - ${info.name}`} className="flex flex-col w-full md:w-auto h-auto md:h-[400px] lg:h-[350px] justify-center items-center bg-[#242424] rounded-md py-5 px-8 transform transition duration-300 hover:-translate-y-1">
            ...
            <ul className="flex flex-row justify-between items-center w-full h-auto mt-5 flex-wrap">
                <li className='flex flex-row w-auto mr-5 h-8 justify-start items-center text-base font-bold'><span className='mr-3 border-l-[8px] border-l-[#2E28A0] border-y-[4px] border-y-transparent border-solid'></span>JavaScript</li>
                <li className='flex flex-row w-auto mr-5 h-8 justify-start items-center text-base font-bold'><span className='mr-3 border-l-[8px] border-l-[#2E28A0] border-y-[4px] border-y-transparent border-solid'></span>Networks</li>
                <li className='flex flex-row w-auto mr-5 h-8 justify-start items-center text-base font-bold'><span className='mr-3 border-l-[8px] border-l-[#2E28A0] border-y-[4px] border-y-transparent border-solid'></span>Tailwind</li>
            </ul>
        </a>
    )
}